...
const { hexStringToBinString } = require("../../dnsserver/dns");
...
class DNSPacket {
    ...
    printPacket(){
        ...
        for(let i = 0; i < output.questions.length; i++){
            ...
            output.questions[i].class = RRClass.number2String(output.questions[i].class);
            output.questions[i].type = RRTypes.number2String(output.questions[i].type);
        }
